...
```bash
python -m ops.select_bundle --recipes runs/eval-v1/selected_recipes.json --output model_bundle --af-cnn-dir runs/cnn-v1/af --af-tree-dir runs/tree-v1/af --bs-cnn-dir runs/cnn-v1/bs --bs-tree-dir runs/tree-v1/bs --bundle-id official-final
...
Сравнение XGBoost для BS завершено: небольшой прирост на validation не оправдал добавление второго backend в выбранный комплект. BS CNN продолжает сравнение. Наличие этих моделей в исходниках не означает, что они включены в поставляемый комплект.
