...
[Скачать `FireWatch-models-ensemble-v3.zip`](https://firewatch.151.247.25.189.nip.io/downloads/FireWatch-models-ensemble-v3.zip) — 17 815 459 байт. Внутри код обучения и инференса, выбранные веса, готовый `submission.csv`, доказательства проверок, паспорт, исследование и презентация. Сырые спутниковые данные получаются отдельно у организаторов; полный код веб-сервиса находится в этом репозитории. [Состав и использование архива](docs/MODEL_DELIVERY.md).

```text
SHA-256: 45317f541bb60b77d67b5ca4729c939bc34446e08097c1b39b1a0f4ce7e96247
```

Проверены целостность 125 файлов архива и контрольные суммы всех элементов manifest. Из распакованного комплекта прошли 22 модельных теста и четыре реальные сцены на CPU. [Проверка поставки](docs/evidence/model-v3-release-summary.json) · [Проверка публичного скачивания](artifacts/service/public-jury-download-v3.json).
